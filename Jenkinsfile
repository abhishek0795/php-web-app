  ...
  stages {
    ...
    stage('Deploy') {
      steps {
       ...
       sh '/Applications/Docker.app/Contents/Resources/bin/docker run -d -p 8080:80 --network=host  --name webapp -e MYSQL_USER=abhishek -e MYSQL_DATABASE=guest -e MYSQL_HOST=myDB -e MYSQL_PASSWORD=abhishek@123 abhishekjha95/php-web-app'
